...
public class DatabaseStory extends SQLiteOpenHelper {
    ...
    private String SQLQuery5 = "INSERT INTO story VALUES (null,'Cậu bé Chu Minh','Người dân vùng sông Mã ở Thanh Hóa vẫn còn kể cho nhau nghe câu chuyện về một cậu bé thời xưa. Tên cậu là Chu Minh. Cậu có tài lặn dưới nước như rái cá.\n" +
            "\n" +
    ...
    private String SQLQuery7 = "INSERT INTO story VALUES (null,'Dân dần quan','Có hai anh lính hầu hạ quan lâu ngày, thấy quan đã ác lại hay ăn tiền, ai có việc vào cửa quan là y như bị đánh đập tàn tệ, đến lúc xì tiền ra mới thôi.\n" +
            "\n" +
    ...
    private String SQLQuery8 = "INSERT INTO story VALUES (null,'Thuần phục sư tử','Ha-li-ma lấy chồng được hai năm. Trước khi cưới, chồng nàng là một người dễ mến, lúc nào cũng tươi cười. Vậy mà giờ đây, chỉ thấy chàng cau có, gắt gỏng. Không biết làm thế nào, Ha-li-ma đến nhờ vị giáo sĩ [1] già trong vùng giúp đỡ.\n" +
            "\n" +
